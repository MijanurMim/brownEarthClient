...
const Projects = () => {
  ...
  return (
    ...
    >
      ...
      <div className=" section--spacing-x my-10  mt-32 grid  grid-cols-1   gap-y-1 md:grid-cols-3 md:gap-2 ">
      ...
      <div className=" section--spacing-x my-10  mb-32 grid  grid-cols-1  gap-y-1 md:grid-cols-3 md:gap-2">
        <div className="flex flex-col items-start justify-center bg-stone-200 p-4 lg:p-10">
          <Link to="/project">
            <h4 className="sub--title">brownearth</h4>
